...
const QA: Array<{ q: string; a: string }> = [
  ...
  {
    // R96 (R75) — was "החזר מלא תוך 30 יום, בלי שאלות". This wasn't
    // a policy we ever implemented and it conflicted with the fact
    // that couples pay once for a specific event. Honest copy: no
    // refund, but the value continues to land for 12 months after.
    q: "מה אם אתחרטו אחרי שרכשתם?",
    a: "Momentum הוא מוצר חי שנבנה לאירוע שלכם — לאחר רכישה אין החזר כספי. אבל: יש לכם גישה מלאה לאירוע ועוד 12 חודשים אחריו, כולל כל הפיצ׳רים, הספקים והדוחות. אם משהו לא עובד — נתקן. אם תרצו שדרוג של פיצ׳ר — נקשיב.",
  },
  {
    // R96 (R75) — explicit vendor cancellation answer.
    q: "אני ספק — איך מבטלים מנוי?",
    a: "בכל עת — לחיצה אחת בהגדרות. המנוי ממשיך עד סוף החודש ששילמתם עליו. בלי קנס, בלי חוזה, בלי שאלות. דף הנחיתה שלכם נשמר 30 יום למקרה שתחזרו.",
  },
  {
  ...
  {
    q: "מה כלול ב-100 הזוגות הראשונים?",
    a: "מחיר השקה ₪99 חד-פעמי (במקום ₪399), שיחת onboarding אישית עם המייסד, גישה מוקדמת לפיצ׳רים חדשים, ושם אישי בקרדיטים של האפליקציה. נשאר 73 מקומות.",
  },
];
